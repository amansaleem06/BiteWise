...
BiteWise ("we", "our") helps you discover restaurants and share food experiences. This policy explains what we collect and why.
...
## Contact
Questions about privacy: privacy@bitewise.app
''';
...
By using BiteWise you agree to these terms.
...
## Acceptable use
Do not post illegal, hateful, harassing, or infringing content. Do not spam, scrape, or attempt to disrupt BiteWise.

## Content license
You keep ownership of your content. You grant BiteWise a non-exclusive license to host and display it so the service can function. You can remove content or delete your account to stop ongoing display of personal profile data.
...
## Disclaimers
BiteWise is provided “as is.” We do not guarantee uninterrupted service or the accuracy of user-generated restaurant content.

## Termination
We may suspend accounts that violate these terms. You may stop using BiteWise and delete your account at any time.
